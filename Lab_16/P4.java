// Develop a Java program for a Banking System where Account is inherited by 
// SavingsAccount, and SavingsAccount is further inherited by LoanAccount. 
// Display account and loan details using multilevel inheritance
class Account{
    int accNo;
    double balance;
